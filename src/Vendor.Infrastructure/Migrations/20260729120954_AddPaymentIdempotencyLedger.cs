...
{
    /// <inheritdoc />
    public partial class AddPaymentIdempotencyLedger : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    KeyUuid = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GatewayReferenceId = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: true),
            ...
            migrationBuilder.CreateTable(
                name: "WebhookEventEntries",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    GatewayName = table.Column<string>(type: "nvarchar(32)", maxLength: 32, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WebhookEventEntries", x => x.Id);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PaymentIdempotencyKeys_KeyUuid",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PaymentLedgerEntries_PaymentId_SequenceNumber",
                table: "PaymentLedgerEntries",
                columns: new[] { "PaymentId", "SequenceNumber" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_WebhookEventEntries_GatewayName_EventId",
                table: "WebhookEventEntries",
                columns: new[] { "GatewayName", "EventId" },
                unique: true);
        }
